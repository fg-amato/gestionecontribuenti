					...
					<div class='card'>
					    ...
					    <div class='card-body'>
							...
							<form:form modelAttribute="edit_contribuente_attr"  method="post" action="${pageContext.request.contextPath }/contribuente/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									<label for="indirizzo" class="form-label">Cognome <span class="text-danger">*</span></label>
									<spring:bind path="indirizzo">
										<input type="text" name="indirizzo" id="indirizzo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire l'indirizzo" value="${edit_contribuente_attr.indirizzo }" required>
									</spring:bind>
