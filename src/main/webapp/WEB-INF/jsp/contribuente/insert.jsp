				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="insert_contribuente_attr" method="post" action="save" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									...
									<input type="text" name="indirizzo" id="indirizzo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire l'indirizzo" value="${insert_contribuente_attr.indirizzo }" required>
									</spring:bind>
